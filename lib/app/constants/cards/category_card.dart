      ...
      child: Stack(
        children: [
          Container(
              ...
              margin: EdgeInsets.only(left: page ? 10 : 15, top: page ? 15 : 10, right: page ? 10 : 0),
          ...
          Positioned.fill(
            ...
            child: Text(
              ...
              style: TextStyle(color: Colors.white, fontFamily: page ? josefinSansBold : josefinSansBold, fontSize: page ? 40 : 25),
            ),
          )),
        ],
      ),
