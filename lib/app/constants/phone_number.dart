  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFormField(
        ...
        style: const TextStyle(color: Colors.black, fontSize: 18, fontFamily: josefinSansMedium),
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: const Padding(
            ...
            child: Text(
              '+ 993',
              style: TextStyle(color: Colors.grey, fontSize: 18, fontFamily: josefinSansMedium),
            ),
          ),
          ...
          hintStyle: TextStyle(color: Colors.grey.withOpacity(0.4), fontFamily: josefinSansMedium),
