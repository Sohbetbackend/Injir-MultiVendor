  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: kPrimaryColor2,
        elevation: 0,
        systemOverlayStyle: SystemUiOverlayStyle(statusBarColor: kPrimaryColor2),
      ),
      body: Column(
        children: [
          Expanded(
              ...
              child: Center(
                child: AnimatedOpacity(
                  ...
                  child: AnimatedContainer(
                      ...
                      child: Text(
                        appName,
                        style: TextStyle(color: kPrimaryColor, fontFamily: josefinSansBold, fontWeight: FontWeight.bold, fontSize: 70),
                      )),
                ),
              ),
            ),
